    ...
    <div className="h-full flex flex-row max-w-screen-lg font-mono">
      ...
      <div className="flex flex-col w-1/4 text-sm place-content-center pl-5 h-full">
        <div style={HEIGHT} className="flex flex-col h-full">
          <strong>About Terry </strong>
          <p className="m-0 mt-1">
            Terry Davis was a talented computer programmer who dedicated a large
            part of his life to the creation of <a target="_blank" href="https://templeos.org">TempleOS</a>. Despite suffering from schizophrenia,
            Terry left this world with impressive accomplishments, and as an inspiration to many.
          </p>
        </div>
      </div>
    </div>
